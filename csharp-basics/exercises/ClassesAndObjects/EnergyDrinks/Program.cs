...
namespace EnergyDrinks
{
    class Program
    {
        ...
        private static void Main(string[] args)
        {
            ...
            Console.WriteLine("Approximately " + CalculateEnergyDrinkers(NumberedSurveyed) +
                              " bought at least one energy drink");
            Console.WriteLine(CalculatePreferCitrus(NumberedSurveyed) + " of those " +
        ...
        {
            return PurchasedEnergyDrinks * numberSurveyed;
        }

        static double CalculatePreferCitrus(int numberSurveyed)
        {
            return PreferCitrusDrinks * numberSurveyed;
        }
    }
}
